  ...
  return (
    <>
      ...
      <HeroSection client:load>
        <Modal.Root class="w-full py-2">
          <Modal.Trigger class="w-full outline-none focus:ring-primary-500 transition-all duration-200 max-w-xl rounded-xl flex items-center justify-between hover:bg-gray-200 dark:hover:bg-gray-800 gap-2 px-4 py-3 h-[45px] ring-2 ring-gray-300 dark:ring-gray-700 mx-auto text-gray-900/70 dark:text-gray-100/70 bg-white dark:bg-black">
          ...
          <Modal.Panel class="w-full backdrop:bg-white/30 dark:backdrop:bg-black/30 backdrop:backdrop-blur-md max-w-xl bg-white dark:bg-black rounded-xl p-4">
